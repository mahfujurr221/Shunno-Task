                ...
                <div class="col-md-8 offset-md-2">
                    <div class="row">
                        <div class="mb-2 form-group">
                            ...
                            <input type="text" class="form-control" name="title" placeholder="Enter Title" required value="{{ $about->title }}">
                            @error('title')
                        ...
                        <div class="mb-2 form-group">
                            ...
                            <input type="text" class="form-control" name="sub_title" placeholder="Enter Sub Title" value="{{ $about->sub_title }}">
                        </div>

                        <div class="mb-2 form-group">
                            <label class="form-label" for="short_description">Short Description</label>
                            <input type="text" class="form-control" name="short_description"
                                placeholder="Enter Short Description" value="{{ $about->short_description }}">
                        </div>
